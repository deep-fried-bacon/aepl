...
function CC = SegTexture_MSKCC(Iin,t,DrawPlot)
if isempty(Iin) 
    imBWFinal = [];
    bBright = [];
    return 
...
bEdges = imBW & ~imerode(imBW,ones(10));
EdgeVal = mean(I(bEdges));
