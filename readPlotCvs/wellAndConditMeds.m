function wellAndConditMeds(exper, condits)
    SUB_DIR = 'summaryCsv';
    CONDIT_SUF = '_median-veloc-conditions.csv';
    WELL_SUF = '_median-veloc-wells.csv';
